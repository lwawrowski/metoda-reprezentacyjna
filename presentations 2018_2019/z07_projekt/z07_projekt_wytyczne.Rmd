...
date: "Aktualizacja: 26.01.2019"
output: html_document
---

# Zadanie

Na podstawie danych o gospodarstwach w populacji generalnej, zaproponuj dwa sposoby losowania (różne warstwy), które pozwolą uzyskać oszacowania zmiennych .... w przekroju .... ze względnym błędem oszacowania nie przekraczającym .... %.
...
Podczas zajęć w dniu 3.02.2019 r. zadania projektowe mają być przedstawione w krótkiej prezentacji (około. 5 slajdów) zawierającej:

1. Treść zadania projektowego
2. Zastosowane schematy losowania
3. Rozmiar próby i uzyskane wyniki w podanym przekroju

Prezentacja w formacie .pdf oraz projekt R (skrypt i plik proba.RData) muszą być wgrane na moodle do dnia 2.02.2019 r., godz. 23:00.

# Kryteria oceny

- zrealizowanie celu zadania - 5 punktów
- przeprowadzenie kalibracji - 1 punkt
- sposób prezentacji wyników - 2 punkty

- zaproponowanie warstwy wykorzystując dane spoza zbioru danych - 3 punkty
- obliczenie przedziałów ufności - 2 punkty
