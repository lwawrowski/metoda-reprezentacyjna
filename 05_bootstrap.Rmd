...
Dla zbioru _apiclus1_ oszacuj metodą bootstrap błąd standardowy oszacowania zmiennej `api99`. Wylosuj 500 podprób i sprawdź jaka jest różnica pomiędzy wynikiem otrzymanym z wykorzystaniem metody bootstrap oraz sposobem analitycznym.
