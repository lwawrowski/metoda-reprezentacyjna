...
Na podstawie zbioru danych z [European Social Survey ](data/ess.RData) przeprowadź estymację 3 wybranych cech w wybranych przekrojach (np. płeć, region, itp.). W przypadku pojawienia się braków danych przeprowadź imputację. Informacje o badaniu ESS znajdują się na [stronie internetowej badania](https://www.europeansocialsurvey.org/data/country.html?c=poland).
