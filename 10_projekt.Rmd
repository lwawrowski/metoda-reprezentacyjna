...
Dla trzech wybranych cech ze zbioru zbioru [PGSS 2010](data/pgss2010.RData) dokonaj estymacji dla kilku wybranych przekrojów społeczno-ekonomicznych (grupy wieku, wykształcenie, itp.) lub terytorialnych (województwa, klasa miejscowości zamieszkania, itp.). W razie potrzeby przed estymacją zastosuj jedną z metod radzenia sobie z brakami danych.
...
Na podstawie zbioru danych z [European Social Survey ](data/ess.RData) przeprowadź estymację trzech wybranych cech w wybranych przekrojach (np. płeć, region, itp.). W przypadku pojawienia się braków danych przeprowadź imputację. Informacje o badaniu ESS znajdują się na [stronie internetowej badania](https://www.europeansocialsurvey.org/data/country.html?c=poland).
