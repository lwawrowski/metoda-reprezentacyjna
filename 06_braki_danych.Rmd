...
Dokonaj imputacji metodą hot-deck zmiennej "Ile powinien zarabiać minister?" (`in5e`) z wykorzystaniem zmiennych pomocniczych: wiek respondenta, liczba osób w gospodarstwie domowym oraz region. Porównaj rozkład otrzymanych wyników z danymi sprzed imputacji.
